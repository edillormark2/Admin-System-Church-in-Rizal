...
import UserRegDeletePopup from "../../../components/AdminComponents/ManageUser/DeleteRegUserPopup";
import { Link } from "react-router-dom";
import { ThreeDots } from "react-loader-spinner";
import CreateRegPopup from "../../../components/AdminComponents/ManageUser/CreateRegPopup";
  ...
  const fetchAdminData = async () => {
    try {
      const response = await axios.get(
        "http://localhost:3000/server/users/userreg/users"
      );
    ...
    },
    {
      ...
      renderCell: params =>
        <div className="flex justify-center gap-1">
          ...
          >
            <Link
              to={`/admin/manage-user/registration-user/${params.row.userID}`}
            >
              <button
                style={{
