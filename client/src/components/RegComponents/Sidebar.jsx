...
import { links } from "./RegMenu"; // Import your links data
...
const Sidebar = () => {
  ...
  const subNavTitle =
    "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-md text-gray-700 m-2 hover:bg-gray-300  cursor-pointer";
