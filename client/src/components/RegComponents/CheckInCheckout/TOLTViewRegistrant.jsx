...
const TOLTViewRegistrant = props => {
  const {
    openViewRegistrant,
  ...
  const fetchRegistrantData = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:3000/server/registrants/tolt-registrant-display/${selectedRegistrant}`
      );
  ...
  const handleCheckIn = async () => {
    try {
      ...
      await axios.put(
        `http://localhost:3000/server/registrants/tolt-registrant-update-checkin/${selectedRegistrant}`,
        {
  ...
  const handleCheckOut = async () => {
    try {
      ...
      await axios.put(
        `http://localhost:3000/server/registrants/tolt-registrant-update-checkout/${selectedRegistrant}`,
        {
...
export default TOLTViewRegistrant;
