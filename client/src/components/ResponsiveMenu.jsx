...
const ResponsiveMenu = ({ showMenu, setShowMenu }) => {
  ...
  return (
    <div
      className={`${showMenu
        ? "left-0"
        : "-left-[100%]"} fixed bottom-0 top-0 flex h-screen w-[50%] flex-col justify-between bg-white dark:bg-secondary-dark-bg dark:text-gray-200 px-4 pb-6 pt-16 text-black transition-all duration-200 md:hidden rounded-r-xl drop-shadow-2xl z-50`}
    >
      <div className="card">
